$(function () {
	...
	// 	var elements = document.querySelectorAll('.metismenu-card');
	...
	// document.addEventListener('DOMContentLoaded', function () {
	// 	var elements = document.querySelectorAll('.card-collapse');
	...
	document.addEventListener("DOMContentLoaded", function () {
		...
		var links = document.querySelectorAll(".metismenu li a");
		
		links.forEach(function(link) {
			if (link.href === currentLocation) {
				link.classList.add(""); // Add appropriate class here if needed
				var parentLi = link.parentElement;
				parentLi.classList.add(""); // Add appropriate class here if needed
